...
import type {ComponentAction, ComponentBehavior, ComponentPlacement, ComponentRuntime, ComponentState, ModelBuilder, ResolvedComponent, ViewType} from './core/contracts.ts';
...
/** One construction boundary for both board and isolated views. */
