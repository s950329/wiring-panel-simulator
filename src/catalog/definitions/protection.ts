...
const breakerTerminals: CatalogTerminalDefinition[] = [
  ...poleBankTerminals(['L1', 'L2', 'L3'], 98, 56, -56),
  ...poleBankTerminals(['T1', 'T2', 'T3'], 98, 33, 56),
];

const fuseTerminals: CatalogTerminalDefinition[] = [
  terminal('F1-IN', [-12, 31, -22], 'power'),
  terminal('F1-OUT', [-12, 31, 22], 'power'),
  terminal('F2-IN', [12, 31, -22], 'power'),
  terminal('F2-OUT', [12, 31, 22], 'power'),
];
