...
export const externalDefinitions = Object.freeze({
  ...
  'teaching-ac220-three-phase-source': {kind: 'three-phase-source', name: '單一三相電源 · AC220V 教學配置', terminals: ['L1','L2','L3']},
...
export function normalizeInputs(id: string, parameters: unknown, state: unknown, path: string): {parameters?: Inputs; state?: Inputs} {
  const info = definitionInfo(id), parameterKeys = info.kind === 'overload' ? ['current'] : [];
