...
const compatibleRevisions = new Set(['WIRE-R8', 'WIRE-R9', 'WIRE-R10', 'WIRE-R11', 'WIRE-R12', 'WIRE-R13', 'WIRE-R14', 'WIRE-R15', 'WIRE-R16', 'WIRE-R17', 'WIRE-R18', 'WIRE-R19','WIRE-R20','WIRE-R21']);
...
export function parseBoardSnapshot(source: string, components: ReadonlyMap<string, ComponentRuntime>, page: BoardViewState['page']) {
  ...
  requireValue(typeof data.revision === 'string' && compatibleRevisions.has(data.revision), '模型版本不相容，支援 WIRE-R8～WIRE-R21 匯出的檔案');
