...
export const ep = (component: string, terminal: string) => ({ component, terminal });
export function minimalProject(): ProjectDocument {
...
export function withAssembly() {
    ...
    p.configuration.components.push({ id: 'aux', definitionId: 'shihlin-ap22', definitionVersion: 1, placement: { assemblyId: 'drive', slot: 'auxiliary' } }, { id: 'thermal', definitionId: 'shihlin-th20', definitionVersion: 1, placement: { assemblyId: 'drive', slot: 'overload' }, parameters: { current: 15 }, state: { trip: false } });
    return p;
}
